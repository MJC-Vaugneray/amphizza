...
public class GraphicService {
    ...
    public BufferedImage textToBufferedImage(String text, int size) throws IOException {
        /*
        ...
        img = new BufferedImage(IMAGE_WIDTH, height, BufferedImage.TYPE_INT_ARGB);
        ...
        g2d.drawString(text, (IMAGE_WIDTH - fm.stringWidth(text))/2, fm.getAscent());
        g2d.dispose();
        return img;
